    ...
    <div class="center-0 ">
         <table border ="2px" class="tb">
            ...
            <tr>
                ...
                <td><strong><%=user.getEnrollment()%></strong></td>
                <td><strong><%= user.getPassword()%></strong></td>
                <td><strong><%=user.getAddress() %></strong></td>
                <td><strong><%= user.getYear()%></strong></td>
                <td><strong><%= user.getAdhar() %></strong></td>
                <td><strong><%= user.getBlood() %></strong></td>
                <td><strong><%= user.getBranch() %></strong></td>
                <td><strong><%= user.getGender() %></strong></td>
                <td><strong><%= user.getMobile() %></strong></td>
                <td><strong><%= user.getDob() %></strong></td>
