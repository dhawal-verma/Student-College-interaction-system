<%-- 
    ...
    Created on : Mar 18, 2022, 2:32:33 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove"> Enter the faculty id of the Admin you want to remove:</span>

     <div class="center">
         
				<form id="form" method="post" action="Deleteadmin">
					<!--<fieldset>-->
                                            <!--<legend style="text-align: center">Login</legend>-->
                                        <!--<label for="text1">Enter the faculty id of the Admin you want to remove:</label>-->
