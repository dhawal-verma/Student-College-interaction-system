...
<!--
    ...
    <marquee direction="right" 
     ...
     <div id = "faculty">
        ...
        HODDAO sdao = new HODDAO();
        DTO dt = sdao.getUserData(enrollment);
//        System.out.println("Enrollment" + enrollment);
        %>
     <div class="center1">
         
				<form id="center1" method="post" action="Updatehodrecord">
					<!--<fieldset>-->
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="username" value="<%= dt.getUsername() %>" /><br />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="enrollment" value="<%= dt.getEnrollment() %>" /><br/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="address" value="<%= dt.getAddress() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <label for="text1">Joining year :</label>
                                                    </td>
                                                    <td>
                                                        <input id="size2" type="text" name="year" value="<%= dt.getYear() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="adhar" value="<%= dt.getAdhar() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="blood" value="<%= dt.getBlood() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="branch" value="<%= dt.getBranch() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="gender" value="<%= dt.getGender() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="mobile" value="<%= dt.getMobile() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="dob" value="<%= dt.getDob() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input id="size2" type="text" name="email" value="<%= dt.getEmail() %>" /><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input style ="margin-left: 150px" id="size1" type="submit" name="submit1" value="Update" />
                                                    </td>
                                                </tr>
                                            </table>
