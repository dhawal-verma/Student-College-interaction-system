<%-- 
    Document   : checkfaculty
    Created on : Mar 18, 2022, 2:29:30 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove">Enter the Faculty Id of the student you want to check:</span>
     <div class="center">
         
				<form id="form" method="post" action="Checkfaculty">
					<!--<fieldset>-->
                                            <!--<legend style="text-align: center">Login</legend>-->
                                        <!--<label for="text1">Enter the Faculty Id of the student you want to check:</label>-->
					<input id="size" type="text" name="enrollment" value="" /><br />
<!--					<label for="text2">Password:</label>
					<input id="size" type="password" name="text2" value="" /><br/>-->
                                        <input id="size1" type="submit" name="submit1" value="Check" />
