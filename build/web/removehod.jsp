<%-- 
    Document   : removehod
    Created on : Mar 18, 2022, 2:33:43 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove"> Enter the faculty id of the H.O.D you want to remove:</span>

     <div class="center">
         
				<form id="form" method="post" action="Deletehod">
					<!--<fieldset>-->
                                            <!--<legend style="text-align: center">Login</legend>-->
                                        <!--<label for="text1">Enter the faculty id of the H.O.D you want to remove:</label>-->
