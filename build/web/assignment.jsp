...
<!--
    ...
    <%
            ...
            List<DTO>  dt = udao.getAssignment();
    ...
    <div class="center-0 ">
        <table border ="2px" class="tb" style="background-color:#009688;color:#ffffff;font-size: 18px; ">
            <tr>
...
<!--                <td><strong>Password</strong></td>
            ...
            %>
            <tr>
                <td><strong><%=user.getAssignment()%></strong></td>
