...
{ 
    public boolean isUpdate(DTO dt) 
    {
        ...
        try
        {
            ...
            pst = con.prepareStatement("update student set Name=?,Enrollment=?,Address=?,Admission_Year=?,Adhar_Number=?,Blood_Group=?,Branch=?,Gender=?,Mobile_Number=?,Date_of_Birth=?,email=? where enrollment = '"+enrollment+"'");
