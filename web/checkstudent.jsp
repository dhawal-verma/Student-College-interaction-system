<%-- 
    ...
    Created on : Mar 18, 2022, 2:30:05 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove">Enter the Enrollment of the student you want to check:</span>
     
     <div class="center">
         
				<form id="form" method="post" action="Checkstudent">
					<!--<fieldset>-->
                                            <!--<legend style="text-align: center">Login</legend>-->
                                        <!--<label for="text1">Enter the Enrollment of the student you want to check:</label>-->
