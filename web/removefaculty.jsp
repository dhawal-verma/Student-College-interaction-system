<%-- 
    ...
    Created on : Mar 18, 2022, 2:33:08 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove"> Enter the faculty id of the faculty you want to remove:</span>
     <div class="center">
         
				<form id="form" method="post" action="Deletefaculty">
					<!--<fieldset>-->
