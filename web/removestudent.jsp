<%-- 
    ...
    Created on : Mar 18, 2022, 2:34:08 PM
    Author     : Dhawal
--%>
...
<!--
    ...
    <marquee direction="right" 
     ...
     <span id="remove"> Enter the Enrollment Number of the student you want to remove:</span>

     <div class="center">
         
				<form id="form" method="post" action="Deletestudent">
					<!--<fieldset>-->
                                            <!--<legend style="text-align: center">Login</legend>-->
                                        <!--<label for="text1">Enter the Enrollment of the student you want to remove:</label>-->
