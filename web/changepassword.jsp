<%-- 
    ...
    Created on : Mar 18, 2022, 2:28:53 PM
    Author     : Dhawal
--%>
     ...
     <div class="center">
				...
				<form id="form" method="post" action="Changepassword">
					<!--<fieldset>-->
                                        ...
                                        <label for="text1">Enter Username:</label>
					<input id="size" type="text" name="username" value="" /><br />
                                        <label for="text1">Enter New Password:</label>
					<input id="size" type="password" name="newpassword" value="" /><br />
                                        <label for="text1">Re-Enter New Password:</label>
					<input id="size" type="password" name="repassword" value="" /><br />
                                        <label for="text1">Enter Old Password:</label>
					<input id="size" type="password" name="password" value="" /><br />
<!--					<label for="text2">Password:</label>
					<input id="size" type="password" name="text2" value="" /><br/>-->
                                        <input id="size1" type="submit" name="submit1" value="Remove" />
